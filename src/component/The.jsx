  ...
  return (
    <div>
       <div className='pt-10 mb-5'data-aos="fade-in" data-aos-duration="2000">
            ...
            <h4 className='text-blue-900 text-center font-bold text-lg md:text-xl'>THE PRIMARY SCHOOL</h4>
            <h4 className='text-blue-900 font-bold text-center text-lg md:text-xl'>I TO IV  </h4>
